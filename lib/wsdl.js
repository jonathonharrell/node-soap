...
var WSDL = function(definition, uri, options) {
  ...
  process.nextTick(function() {
    try {
      fromFunc.call(self, definition, options);
    } catch (e) {
...
WSDL.prototype.xmlToObject = function(xml, options) {
  var self = this;
  options = options || {};
  var strict = options.strict === false ? false : true;
  var p = sax.parser(strict);
  var objectName = null;
  var root = {};
  var schema = {
    Envelope: {
...
WSDL.prototype._parse = function(xml, options) {
  var self = this,
...
WSDL.prototype._fromXML = function(xml, options) {
  this.definitions = this._parse(xml, options);
...
WSDL.prototype._fromServices = function(services, options) {
